...
function generatePassword (){
  chooseNumber = parseInt(prompt("How many characters do you want your password to be? Choose between 8 and 128"));

  if (!chooseNumber) {
    alert("This needs a value! Try again.");
  } else if (chooseNumber < 8 || chooseNumber > 128) {
    chooseNumber = parseInt("You must enter a value between 8-128 to proceed");
